 ...
 * @author USUARIO
 */
public class JFrameAdminGU extends javax.swing.JFrame {
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        try {
            ...
            Logger.getLogger(JFrameAdminGU.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameAdminGU.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameAdminGU(null).setVisible(true);
            }
        });
    }
